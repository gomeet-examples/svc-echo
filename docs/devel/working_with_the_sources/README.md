...
svc-echo needs some requirements :
...
git clone https://github.com/gomeet-examples/svc-echo.git
cd svc-echo
...
If svc-echo repository is private and you use [Gogs](https://gogs.io/) has remote server.
