...
Or via an interactive console :
  ...
  $ svc-echo console
  $ svc-echo console --address localhost:42000
...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.svc-echo.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".svc-echo") // name of config file (without extension)
