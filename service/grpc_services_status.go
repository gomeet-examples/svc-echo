...
func svcCurrentStatus(s *echoServer, ctx context.Context, svcCtx context.Context) *pb.ServiceStatus {
...
// func svc{{SubServiceNamePascalCase}}Status(s *echoServer, ctx context.Context, svcCtx context.Context) *pb.ServiceStatus {
...
func (s *echoServer) ServicesStatus(ctx context.Context, req *pb.EmptyMessage) (*pb.ServicesStatusList, error) {
	...
	fns := []func(*echoServer, context.Context, context.Context) *pb.ServiceStatus{
		svcCurrentStatus,
	...
	wg.Add(len(fns))
	for _, fn := range fns {
		go func(f func(*echoServer, context.Context, context.Context) *pb.ServiceStatus) {
			defer wg.Done()
